...
MIN_VOLUME_24H = int(os.environ.get("SIGNALS_MIN_VOLUME_24H_USD", "1000000"))
TOP_COINS_FREE = int(os.environ.get("TECH_TOP_COINS_FREE", "15"))
DEFAULT_TIMEFRAME = "1h"
GEMINI_MODEL = "models/gemini-2.5-flash-lite"

# Proprietary technical parameters (from GitHub Secrets / env)
RSI_OVERSOLD = int(os.environ.get("TECH_RSI_OVERSOLD", "35"))
RSI_OVERBOUGHT = int(os.environ.get("TECH_RSI_OVERBOUGHT", "65"))
CONFIDENCE_RSI = int(os.environ.get("TECH_CONFIDENCE_RSI", "20"))
CONFIDENCE_MACD = int(os.environ.get("TECH_CONFIDENCE_MACD", "15"))
CONFIDENCE_SMA = int(os.environ.get("TECH_CONFIDENCE_SMA", "15"))
CONFIDENCE_VOLUME = int(os.environ.get("TECH_CONFIDENCE_VOLUME", "10"))
CONFIDENCE_SUPPORT = int(os.environ.get("TECH_CONFIDENCE_SUPPORT", "15"))
CONFIDENCE_RESISTANCE = int(os.environ.get("TECH_CONFIDENCE_RESISTANCE", "10"))
VOLUME_SPIKE_MULTIPLIER = float(os.environ.get("TECH_VOLUME_SPIKE_MULTIPLIER", "1.5"))
NEAR_SUPPORT_OFFSET = float(os.environ.get("TECH_NEAR_SUPPORT_OFFSET", "1.05"))
NEAR_RESISTANCE_OFFSET = float(os.environ.get("TECH_NEAR_RESISTANCE_OFFSET", "0.95"))
RISK_HIGH_THRESHOLD = float(os.environ.get("TECH_RISK_HIGH_THRESHOLD", "0.05"))
RISK_MEDIUM_THRESHOLD = float(os.environ.get("TECH_RISK_MEDIUM_THRESHOLD", "0.03"))

# Proprietary ATR multipliers (from GitHub Secrets / env)
ATR_SL_CONSERVATIVE = float(os.environ.get("TECH_ATR_SL_CONSERVATIVE", "1.5"))
ATR_TP1_CONSERVATIVE = float(os.environ.get("TECH_ATR_TP1_CONSERVATIVE", "2.0"))
ATR_SL_OPTIMIZED = float(os.environ.get("TECH_ATR_SL_OPTIMIZED", "2.0"))
ATR_TP1_OPTIMIZED = float(os.environ.get("TECH_ATR_TP1_OPTIMIZED", "2.0"))
ATR_TP2_OPTIMIZED = float(os.environ.get("TECH_ATR_TP2_OPTIMIZED", "3.5"))
ATR_TP3_OPTIMIZED = float(os.environ.get("TECH_ATR_TP3_OPTIMIZED", "5.0"))
